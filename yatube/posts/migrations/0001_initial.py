# Generated by Django 2.2.16 on 2023-04-11 10:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField(help_text='just text', verbose_name='content')),
                ...
                ('group', models.ForeignKey(blank=True, help_text='foreign key field', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='posts.Group', verbose_name='group')),
            ],
            options={
                'ordering': ['-pub_date'],
            },
